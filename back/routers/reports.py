...
def create_report(
    ...
    try:
        ...
        # [수정] 유효하지 않은 데이터(None) 처리 - ResponseValidationError 방지
        if not result:
        ...
        # 필요하다면 여기에 다른 slack.send_message(...) 코드를 작성하시면 됩니다.
        ...
        # 필요 시 에러 발생 상황을 슬랙으로 알림
        # slack.send_error_log(str(e)) 
