...
용도: 시스템 자동화 작업(Cron Jobs) 정의 (비동기 리팩토링)
...
async def report_monthly_stats():
    """
    ...
    async with SessionLocal() as db:
        ...
        try:
            ...
            result = (await db.execute(sql, {"start_date": last_month_start, "end_date": last_month_end})).first()
...
async def report_ghost_users():
    ...
    async with SessionLocal() as db:
        ...
        try:
            ...
            results = (await db.execute(sql)).fetchall()
